...
這是 2021 高職專題的封存展示倉。歡迎修文件、補編譯註記、加**自製**提示音。請先當歷史文物看，再動手。
...
3. 衝突時：**2021 繳交行為 > 展示倉文件**。文件寫錯就改文件，不要為了「比較現代」重寫 BT9 邏輯。
...
3. 若改了 `BT9.ino`，在 [`docs/firmware.md`](docs/firmware.md) 註明「展示倉偏離繳交檔」的那幾行
